...
public class Main {
	...
	public static void main(String[] args) {
		...
		Student student1 = new Student(1, "Ramazan", "kayış", "0000000", "ramazank@gmail.com", "pppppp",
				"87887889898", 2);
		Student student2 = new Student(2, "rümeysa", "yavaş", "111111", "rümeysay@gmail.com", "oooooo",
				"12121212121", 1);
		Student[] students = { student1, student2 };
		studentManager.getAllDetailStudents(students);

		System.out.println("*123****Öğretmen*****Eğimen*123**");
		Instructor instructor1 = new Instructor(3, "Engin", "Demiroğ", "9999999", "engind@gmail.com",
				"45454545454545", 3, 20000);
		Instructor instructor2 = new Instructor(4, "Esra", "Sancak", "88888888", "esras@gmail.com",
				"969696969699", 6, 12000);
